...
# # Define a function to extract and append all tables concurrently
...
#         # Submit tasks for processing each sheet concurrently
#         futures = [executor.submit(process_sheet, sheet) for sheet in workbook.worksheets()]

#         # Retrieve results from completed tasks
#         appended_tables = [future.result() for future in futures]

#     # Concatenate DataFrames obtained from different sheets
#     appended_table = pd.concat(appended_tables, ignore_index=True)
...
# # Define a function to format integers to have 16 digits
...
# # Define a function to load data into Google Sheets
...
# # Define company and country names
# company_name = 'SMARTMARTLTD'
# country_name = 'NIGERIA'

# # Define Google Sheet key
# sheet_key = "1e7ZZBRt37kEElHnyFF_VV_4bVRqjy3oXNw8cY1OhIcw"
...
# # Define function to load data into DataFrame from Google Sheets
